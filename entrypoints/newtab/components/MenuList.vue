...
<template>
  <transition name="bounce">
    <div
      ...
      bg="white/40"
      fixed z-9999 w-150px flex flex-col py-2 backdrop-blur-md
      :style="menuStyle"
    >
      <div
        ...
        w-full flex cursor-pointer items-center justify-start px-2 py-0 text-xs leading-35px
        @click="emit('menu-click', { type: item.emit, data: menuData })"
      >
        <svg class="icon" mr-1 h-4 w-4 aria-hidden="true">
